...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO produtos (nome, descricao, preco, categoria, badge, icon, marca, modelo, estoque, peso, dimensoes, especificacoes) 
            VALUES ('$nome','$descricao','$preco','$categoria','$badge','$icon','$marca','$modelo','$estoque','$peso','$dimensoes','$especificacoes')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if (isset($_FILES['imagens']) && !empty($_FILES['imagens']['name'][0])) {
            ...
            for ($i = 0; $i < count($_FILES['imagens']['name']); $i++) {
                ...
                if (move_uploaded_file($arquivo['tmp_name'], $caminho_arquivo)) {
                    ...
                    $sqlImg = "INSERT INTO produto_imagens (produto_id, imagem_url, ordem) VALUES ($produto_id, '$url_relativa_escapada', $ordem)";
                    $conn->query($sqlImg);
                    $ordem++;
                }
            }
        ...
        // Processar URLs de imagens manualmente inseridas
        if (isset($_POST['imagens_url']) && !empty($_POST['imagens_url'])) {
            $imagens = explode("\n", $_POST['imagens_url']);
            foreach ($imagens as $imagem) {
                $imagem = trim($imagem);
                if (!empty($imagem)) {
                    $imagem_escapada = $conn->real_escape_string($imagem);
                    $sqlImg = "INSERT INTO produto_imagens (produto_id, imagem_url, ordem) VALUES ($produto_id, '$imagem_escapada', $ordem)";
                    $conn->query($sqlImg);
                    $ordem++;
                }
            }
        ...
        $mensagem_upload = "Erro ao criar produto: " . $conn->error;
        $tipo_mensagem = 'erro';
    }
}
?>
    ...
    <div class="form-container">
        ...
        <?php if (!empty($mensagem_upload)): ?>
            <div class="mensagem <?= $tipo_mensagem ?>">
                <?= htmlspecialchars($mensagem_upload) ?>
            </div>
        <?php endif; ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="descricao" name="descricao" class="large" placeholder="Descreva os detalhes e características do produto..."></textarea>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="estoque" name="estoque" required placeholder="0" value="0">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="categoria" name="categoria" placeholder="Ex: Ferramentas, Elétrica">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="badge" name="badge" placeholder="Ex: Novo, Promoção">
                    </div>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="marca" name="marca" placeholder="Ex: Bosch">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="modelo" name="modelo" placeholder="Ex: XYZ-1000">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="dimensoes" name="dimensoes" placeholder="Ex: 30x20x15 cm">
                    </div>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="especificacoes" name="especificacoes" class="large" placeholder="Uma por linha"></textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group full-width">
                    <label for="imagens">
                        <i class="fas fa-cloud-upload-alt"></i> Upload de Imagens
                    </label>
                ...
                <div class="form-group full-width">
                    <label for="imagens_url">
                        <i class="fas fa-link"></i> Ou Cole URLs de Imagens
                    </label>
                    <textarea id="imagens_url" name="imagens_url" placeholder="Cole URLs, uma por linha:"></textarea>
                </div>
            </div>
                ...
                reader.onload = (e) => {
                    ...
                    div.innerHTML = `
                        ...
                        <div class="imagem-overlay">
                            <button type="button" class="btn-deletar-img" onclick="removerArquivo(${index})">
